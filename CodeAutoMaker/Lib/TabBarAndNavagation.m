...
@implementation CCTabBarAndNavagation
...
+ (void)setLeftItem:(CCBarItem)leftBarItem rightItem:(CCBarItem)rightBarItem target:(UIViewController *)target{
    CCTabBarAndNavagation *leftItem=[CCTabBarAndNavagation new];
    ...
    CCTabBarAndNavagation *rightItem=[CCTabBarAndNavagation new];
