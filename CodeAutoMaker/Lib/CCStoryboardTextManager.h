...
typedef NS_ENUM(NSUInteger, CCAddCodeType) {
    CCAddCodeType_Implementation=0,
    CCAddCodeType_end_last=1,
    CCAddCodeType_Interface=2,
    CCAddCodeType_Import=3,
    CCAddCodeType_InsertFunction=4,
    CCAddCodeType_Delegate
};

@interface CCStoryboardTextManager : NSObject
