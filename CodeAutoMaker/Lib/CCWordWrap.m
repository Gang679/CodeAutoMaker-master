...
- (void)Begin:(NSString *)str{
    ...
    switch ([CCFileManager getFileType:filePath]) {
        ...
        {
            NSArray *fileArr=[CCFileManager subPathFileArrInDirector:filePath hasPathExtension:@[@".h",@".m"]];
            NSUInteger sum=0;
