...
- (void)refreshUI:(StroyBoardCreatePropertyCellModel *)dataModel{
	...
	self.nameLabel.text=[CCFileManager getFileNameNoPathComponentFromFilePath:dataModel.title];
    self.subTitleLabel.text=[CCFileManager getFileNameNoPathComponentFromFilePath:dataModel.subTitle];
}
